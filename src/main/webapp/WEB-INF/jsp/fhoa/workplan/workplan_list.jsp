                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
										...
										<form action="workplan/list" method="post" name="Form" id="Form">
											<!-- 检索  -->
																	...
																	<tr>
																		...
																		<td>
																			<shiro:hasPermission name="workplan:edit"><a title="修改" onclick="edit('${var.WORKPLAN_ID}');" style="cursor:pointer;"><i class="feather icon-edit-2"></i></a></shiro:hasPermission>
										                 					<shiro:hasPermission name="workplan:del"><a title="删除" onclick="del('${var.WORKPLAN_ID}');" style="cursor:pointer;"><i class="feather icon-x"></i></a></shiro:hasPermission>
																		</td>
																	</tr>
																</c:forEach>
															</c:when>
													...
													<table style="width:100%;margin-top:15px;">
														<tr>
															<td style="vertical-align:top;">
																<shiro:hasPermission name="workplan:add"><a class="btn btn-light btn-sm" onclick="add();">新增</a></shiro:hasPermission>
															</td>
...
<script type="text/javascript">
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>workplan/excel';
		}
